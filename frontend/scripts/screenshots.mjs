...
const ME = { authenticated: true, is_admin: false, id: 1, email: 'demo@zauberkoch.de', name: 'Demo', picture_url: '', adult_confirmed: true, csrf_token: 'x', preferences: { vegetarisch: false, vegan: false, glutenfrei: false, laktosefrei: false, vermeiden: [], standard_personen: 2 } };
