...
- **PWA**: Service Worker mit versioniertem Cache `zauberkoch-vN` (aktuell **v23**) — bei jedem App-Shell-Change bumpen und Version hier nachführen. Favoriten offline lesbar.
